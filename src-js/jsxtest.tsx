import { createElement } from "./jsxtest2.ts";
...
function Gaming(props: {foo: number}, ...children: JSX.Element[]): tags.Showable {
  return <div>
    <h1>Welcome to my {props.foo}th game</h1>
    {...children}
  </div>
}

console.log((<div><Gaming foo={125}><h2 style="geek"></h2></Gaming></div>).show(0));
